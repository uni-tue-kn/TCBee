// contains logic for styling the application
// references taken from: https://github.com/13r0ck/bathtub/blob/main/src/style.rs
// and https://github.com/iced-rs/iced/discussions/1266
// and https://github.com/iced-rs/iced/blob/master/examples/styling/src/main.rs#L157
...
impl Theme {
    pub const ALL: [Self; 3] = [Self::Cozy, Self::Dark, Self::Light];
