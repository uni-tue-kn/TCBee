...
use crate::duckdb::queries::{
    ...
    DELETE_FLOW_BY_TUPLE, DELETE_TIME_SERIES_BY_NAME, INSERT_FLOW, INSERT_FLOW_ATTRIBUTE,
    INSERT_TIME_SERIES, INSERT_TIME_SERIES_DATA, SELECT_ALL_FLOWS, SELECT_FIRST_TIME_SERIES_DATA,
    SELECT_FLOW_ATTRIBUTES_BY_FLOW_ID, SELECT_FLOW_ATTRIBUTE_BY_ID,
    SELECT_FLOW_ATTRIBUTE_BY_NAME, SELECT_FLOW_BY_ID, SELECT_FLOW_BY_TUPLE,
    SELECT_HIGHEST_TIME_SERIES_DATA, SELECT_LAST_TIME_SERIES_DATA,
    SELECT_LOWEST_TIME_SERIES_DATA, SELECT_TIME_SERIES_BY_FLOW,
    SELECT_TIME_SERIES_BY_FLOW_AND_NAME, SELECT_TIME_SERIES_BY_ID,
