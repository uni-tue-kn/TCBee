...
pub const SELECT_TIME_SERIES_BY_ID: &str = "SELECT * FROM time_series WHERE time_series_id = ?;";
...
pub const SELECT_TIME_SERIES_DATA_IN_RANGE: &str = "SELECT * FROM time_series_data WHERE time_series_id = ? AND timestamp >= ? AND timestamp <= ? ORDER BY timestamp ASC";
...
pub const SELECT_LOWEST_TIME_SERIES_DATA: &str = "SELECT * FROM time_series_data WHERE time_series_id = ? ORDER BY value ASC LIMIT 1";
pub const SELECT_HIGHEST_TIME_SERIES_DATA: &str = "SELECT * FROM time_series_data WHERE time_series_id = ? ORDER BY value DESC LIMIT 1";
